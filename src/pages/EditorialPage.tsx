...
const lookbookImages = [
  ...
  'https://images.pexels.com/photos/10409446/pexels-photo-10409446.jpeg?auto=compress&cs=tinysrgb&w=1200',
  'https://images.pexels.com/photos/16196537/pexels-photo-16196537.jpeg?auto=compress&cs=tinysrgb&w=1200',
];
    ...
    <div className="min-h-screen bg-noir pt-24">
      ...
      <section className="relative h-[80vh] overflow-hidden">
        <div className="absolute inset-0">
          <img src={lookbookImages[0]} alt="BUKSY Editorial" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 h-full flex flex-col justify-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <h1 className="section-title max-w-2xl">
              {t('editorial.title')} <span className="text-blood">.</span>
            </h1>
            <p className="text-lg text-white/70 leading-relaxed max-w-xl mt-6 mb-10 font-body">
              {t('editorial.heroText')}
            </p>
            <Link to="/shop" className="btn-primary inline-flex items-center gap-3">
              {t('editorial.exploreCollection')} <ArrowRight size={18} />
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
          {[
            { img: lookbookImages[1], caption: 'editorial.caption1', layout: 'lg:flex-row' },
            { img: lookbookImages[2], caption: 'editorial.caption2', layout: 'lg:flex-row-reverse' },
            { img: lookbookImages[3], caption: 'editorial.caption3', layout: 'lg:flex-row' },
          ].map((item, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 40 }}
              whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className={`flex flex-col ${item.layout} items-center gap-12`}>
              <div className="lg:w-2/3">
                <div className="aspect-[4/3] overflow-hidden">
                  <img src={item.img} alt="" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}>
              <div className="aspect-[4/3] overflow-hidden">
                <img src={lookbookImages[4]} alt="Behind the scenes" className="w-full h-full object-cover" />
              </div>
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }}
              ...
              <Link to="/about" className="btn-secondary inline-flex items-center gap-3">
                {t('editorial.viewLookbook')} <ArrowRight size={18} />
              </Link>
            </motion.div>
          </div>
        </div>
      ...
      <section className="h-screen relative overflow-hidden">
        <img src={lookbookImages[5]} alt="" className="w-full h-full object-cover" />
